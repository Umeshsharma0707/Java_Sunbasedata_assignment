...
<% String city = (String)request.getAttribute("city"); %>
    <h2>Customer By City : <h1> <% out.print(city); %></h1> </h2>
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-dark">
            ...
            <tbody>
            	...
            	<% List<Customer> list = SearchDao.getByCity(city); %>
            	<%for(Customer c: list){ %>
                <tr>
                ...
                <%if(list.isEmpty()){ %>
                <p style="color: red; font-size: 20px"><%out.print("No data found with city : " + city); %></p>
                <%} %>
            </tbody>
        </table>
    </div>
