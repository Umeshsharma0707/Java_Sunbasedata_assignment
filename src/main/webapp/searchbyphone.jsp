...
<% String phone = (String)request.getAttribute("phone"); %>
    <h2>Customer By phone : <h1> <% out.print(phone); %></h1> </h2>
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-dark">
            ...
            <tbody>
            	...
            	<% List<Customer> list = SearchDao.getByPhone(phone); %>
            	<%for(Customer c: list){ %>
                <tr>
                ...
                <%if(list.isEmpty()){ %>
                <p style="color: red; font-size: 20px"><%out.print("No data found with Phone Number : " + phone); %></p>
                <%} %>
            </tbody>
        </table>
    </div>
