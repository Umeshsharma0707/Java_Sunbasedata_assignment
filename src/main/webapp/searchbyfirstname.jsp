...
<% String firstname = (String)request.getAttribute("firstname"); %>
    <h2>Customer By firstname : <h1> <% out.print(firstname); %></h1> </h2>
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-dark">
            ...
            <tbody>
            	...
            	<% List<Customer> list = SearchDao.getByFirstName(firstname); %>
            	<%for(Customer c: list){ %>
                <tr>
                ...
                <%} %>
                <%if(list.isEmpty()){ %>
                <p style="color: red; font-size: 20px"><%out.print("No data found with Firstname : " + firstname); %></p>
                <%} %>
            </tbody>
        </table>
    </div>
